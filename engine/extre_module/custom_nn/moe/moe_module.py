'''
本文件由BiliBili：魔傀面具整理     
engine/extre_module/module_images/ES-MoE.png
engine/extre_module/module_images/ES-MoE.md
论文链接：https://arxiv.org/pdf/2512.23273 
'''     
...
from engine.extre_module.custom_nn.moe.routers import *    
from engine.extre_module.custom_nn.moe.experts import *
from engine.extre_module.custom_nn.moe.loss import MoELoss   
...
if __name__ == '__main__':
    ...
    module = ESMoE(in_channel, out_channel).to(device)     
